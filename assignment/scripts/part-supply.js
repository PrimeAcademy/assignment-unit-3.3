...
console.log("second item in supplyChanges:", supplyChanges[1]);
...
console.log("parts available:", partsAvailable);
...
console.log("filled boxes:", boxes.length);
console.log("remaining parts", warehouseParts);
